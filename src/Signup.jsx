...
function Signup() {
  ...
  return (
    <div className='signup' style={{background:"linear-gradient(120deg, #1e3c72 0%, #2a5298 100%)"}}>
    ...
    <Card className='signup-main' style={{boxShadow:"0 8px 32px rgba(0, 0, 0, 0.3)",background:"rgba(255, 255, 255, 0.1)",color:"white"}}>
        <Card.Body className='sign-form p-4'>
            <h2 className='mb-4 text-center'>Sign Up</h2>
            {error && <Alert variant="danger">{error}</Alert>}
            <Form className='w-100' onSubmit={handleSubmet}>
